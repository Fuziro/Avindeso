...
|                                                    |
| [--] Name: Avindeso - Tools ku                     |
|                                                    |
| [--] Have Services: 51                             |
|                                                    |
| [--] Created by: https://github.com/Fuziro/        |
|                                                    |
| [--] Version: 1.0.6                                |
|____________________________________________________|
"""
...
_phone9 = _phone[1:]
_phoneAresBank = '+'+_phone[0]+'('+_phone[1:4]+')'+_phone[4:7]+'-'+_phone[8:5]+'-'+_phone[8:3]
_phone9dostavista = _phone9[:3]+'+'+_phone9[3:6]+'-'+_phone9[6:8]+'-'+_phone9[8:10]
_phoneOstin = '+'+_phone[0]+'+('+_phone[1:4]+')'+_phone[4:7]+'-'+_phone[8:5]+'-'+_phone[9:11]
_phonePizzahut = '+'+_phone[0]+' ('+_phone[1:4]+') '+_phone[4:7]+' '+_phone[8:5]+' '+_phone[9:11]
_phoneGorzdrav = _phone[1:4]+') '+_phone[4:8]+'-'+_phone[8:9]+'-'+_phone[9:11]
